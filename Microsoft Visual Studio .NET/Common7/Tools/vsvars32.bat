@SET VSINSTALLDIR=C:\Program Files (x86)\Microsoft Visual Studio .NET\Common7\IDE
@SET VCINSTALLDIR=C:\Program Files (x86)\Microsoft Visual Studio .NET
@SET FrameworkDir=C:\WINDOWS\Microsoft.NET\Framework
@SET FrameworkVersion=v1.0.3705
@SET FrameworkSDKDir=C:\Program Files (x86)\Microsoft Visual Studio .NET\FrameworkSDK
