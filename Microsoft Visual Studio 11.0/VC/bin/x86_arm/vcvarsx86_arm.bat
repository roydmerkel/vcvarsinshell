...
@call "%VS110COMNTOOLS%VCVarsQueryRegistry.bat" 32bit 64bit
...
@if not "%WindowsSdkDir_old%" == "" (
	@set "PATH=%WindowsSdkDir_old%bin\NETFX 4.0 Tools;%WindowsSdkDir_old%bin;%PATH%"
)
...
@if not "%WindowsSdkDir%" == "" (
	...
	@set "LIB=%WindowsSdkDir%lib\win8\um\ARM;%LIB%"
