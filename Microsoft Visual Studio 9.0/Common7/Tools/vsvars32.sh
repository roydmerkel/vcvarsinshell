...
if [ "${VSINSTALLDIR}" == "" ]; then 
	...
	if [ "${PATH:-}" != "" ]; then
		export PATH="${vc}/Common7/IDE:${vc}/VC/BIN:${vc}/Common7/Tools:${windir:-/mnt/c/WINDOWS}/Microsoft.NET/Framework/v3.5:${windir:-/mnt/c/WINDOWS}/Microsoft.NET/Framework/v2.0.50727:${vc}/VC/VCPackages:${PATH}"
	else
		export PATH="${vc}/Common7/IDE:${vc}/VC/BIN:${vc}/Common7/Tools:${windir:-/mnt/c/WINDOWS}/Microsoft.NET/Framework/v3.5:${windir:-/mnt/c/WINDOWS}/Microsoft.NET/Framework/v2.0.50727:${vc}/VC/VCPackages"
	fi
	if [ "${INCLUDE:-}" != "" ]; then
		export INCLUDE="${vc}/VC/ATLMFC/INCLUDE:${vc}/VC/INCLUDE:${INCLUDE}"
	else
		export INCLUDE="${vc}/VC/ATLMFC/INCLUDE:${vc}/VC/INCLUDE"
	fi
	if [ "${LIB:-}" != "" ]; then
		export LIB="${vc}/VC/ATLMFC/LIB:${vc}/VC/LIB:${LIB}"
	else
		export LIB="${vc}/VC/ATLMFC/LIB:${vc}/VC/LIB"
	fi
	if [ "${LIBPATH:-}" != "" ]; then
		export LIBPATH="${windir:-/mnt/c/WINDOWS}/Microsoft.NET/Framework/v3.5:${windir:-/mnt/c/WINDOWS}/Microsoft.NET/Framework/v2.0.50727:${vc}/VC/ATLMFC/LIB:${vc}/VC/LIB:${LIBPATH}"
	else
		export LIBPATH="${windir:-/mnt/c/WINDOWS}/Microsoft.NET/Framework/v3.5:${windir:-/mnt/c/WINDOWS}/Microsoft.NET/Framework/v2.0.50727:${vc}/VC/ATLMFC/LIB:${vc}/VC/LIB"
	fi
fi
